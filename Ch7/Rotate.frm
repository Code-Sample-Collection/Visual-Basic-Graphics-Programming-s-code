...
Dim old_hgt As Single
    ...
    If new_wid < cmdRotate.Left + cmdRotate.Width _
        Then new_wid = cmdRotate.Left + cmdRotate.Width
...
Dim file_name As String
    ...
    Caption = "Rotate [" & dlgOpenFile.FileTitle & "]"
    ...
    If cmdRotate.Left + cmdRotate.Width > picOriginal.Left + picOriginal.Width Then
        Width = cmdRotate.Left + cmdRotate.Width + 120 + Width - ScaleWidth
    Else
        Width = picOriginal.Left + picOriginal.Width + 120 + Width - ScaleWidth
    End If
    Height = picOriginal.Top + picOriginal.Height + 120 + Height - ScaleHeight
