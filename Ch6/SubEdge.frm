...
Dim Y As Integer
    ...
    For Y = 0 To picOriginal.ScaleHeight - 2
        For X = 0 To picOriginal.ScaleWidth - 2
            With pixels(X, Y)
...
Dim file_name As String
    ...
    Caption = "SubEdge [" & dlgOpenFile.FileTitle & "]"
