...
Dim i As Integer
    ...
    new_iter = FractalForm.MaxIterations
    On Error Resume Next
    new_iter = CInt(txtMaxIterations)
    On Error GoTo 0
    If new_iter < 1 Then new_iter = 1
    FractalForm.MaxIterations = new_iter
...
Dim j As Integer
    ...
    Set FractalForm = frm
    txtMaxIterations.Text = Format$(FractalForm.MaxIterations)
