...
Dim dt As Single
    ...
    If picCanvas.ScaleWidth < picCanvas.ScaleHeight Then
        Radius = picCanvas.ScaleWidth * 0.45
    Else
        Radius = picCanvas.ScaleHeight * 0.45
    End If
