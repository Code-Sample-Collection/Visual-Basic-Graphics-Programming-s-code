...
' Playing is False.
Private Sub PlayImagesBackAndForth()
    ' Start the animation.
    Do While Playing
        PlayImagesOnce
...
' is False.
Private Sub PlayImagesReversed()
Dim i As Integer
...
Dim file_name As String
    ...
    Caption = "PlayFast [" & dlgOpenFile.FileTitle & "]"
