...
Dim i As Integer
    ...
    For i = 1 To 5
        TheSurface.SetControlPoint i, 1, -1.5 * R(i), h(i), 0
        TheSurface.SetControlPoint i, 2, -1.5 * R(i), h(i), -1.5 * R(i)
        TheSurface.SetControlPoint i, 3, 1.5 * R(i), h(i), -1.5 * R(i)
        TheSurface.SetControlPoint i, 4, 1.5 * R(i), h(i), 1.5 * R(i)
        TheSurface.SetControlPoint i, 5, -1.5 * R(i), h(i), 1.5 * R(i)
        TheSurface.SetControlPoint i, 6, -1.5 * R(i), h(i), 0
    Next i
End Sub
...
Private Sub MakeSpiral()
    TheSurface.SetBounds 5, 3

    TheSurface.SetControlPoint 1, 1, -4, 2, 0
    TheSurface.SetControlPoint 1, 2, -4, 0, 0
    TheSurface.SetControlPoint 1, 3, -4, -2, 0
    TheSurface.SetControlPoint 2, 1, -2, 0, -4
    TheSurface.SetControlPoint 2, 2, -2, 0, 0
    TheSurface.SetControlPoint 2, 3, -2, 0, 4
    TheSurface.SetControlPoint 3, 1, 0, -4, 0
    TheSurface.SetControlPoint 3, 2, 0, 0, 0
    TheSurface.SetControlPoint 3, 3, 0, 4, 0
    TheSurface.SetControlPoint 4, 1, 2, 0, 4
    TheSurface.SetControlPoint 4, 2, 2, 0, 0
    TheSurface.SetControlPoint 4, 3, 2, 0, -4
    TheSurface.SetControlPoint 5, 1, 4, 2, 0
    TheSurface.SetControlPoint 5, 2, 4, 0, 0
    TheSurface.SetControlPoint 5, 3, 4, -2, 0
End Sub
...
Private Sub MakeTwist()
    ...
    TheSurface.SetControlPoint 1, 1, -3, 0, -3
    TheSurface.SetControlPoint 1, 2, -3, 0, 0
    TheSurface.SetControlPoint 1, 3, -3, 0, 3
    TheSurface.SetControlPoint 2, 1, 0, -1.7, -1.7
    TheSurface.SetControlPoint 2, 2, 0, 0, 0
    TheSurface.SetControlPoint 2, 3, 0, 1.7, 1.7
    TheSurface.SetControlPoint 3, 1, 3, -3, 0
    TheSurface.SetControlPoint 3, 2, 3, 0, 0
    TheSurface.SetControlPoint 3, 3, 3, 3, 0
End Sub
...
Dim j As Integer
    ...
    TheSurface.SetBounds 5, 5

    ' Start flat and modify from there.
    For i = 1 To 5
        For j = 1 To 5
            TheSurface.SetControlPoint i, j, 2 * (i - 3), 0, 2 * (j - 3)
        Next j
    Next i

    ' Make the modifications.
    TheSurface.SetControlPoint 3, 3, 0, 5, 0
End Sub
