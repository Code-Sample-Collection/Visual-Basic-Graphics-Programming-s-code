...
Private TheGrid As AltitudeGrid3d
...
Dim PST(1 To 4, 1 To 4) As Single
    ...
    ' Make the color vary from green to red.
    TheGrid.MinColor = vbGreen
    TheGrid.MaxColor = vbRed
...
Dim Dy As Single
    ...
    Set TheGrid = New AltitudeGrid3d
