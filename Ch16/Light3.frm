...
Dim PST(1 To 4, 1 To 4) As Single
    ...
    pic.Cls
    For Each solid In Solids
        solid.Draw pic, LightSources, THE_AMBIENT_LIGHT
    Next solid
    pic.Refresh
End Sub
' Make a sphere.
...
Dim new_solid As Solid3d
    ...
    new_solid.SetAmbientCoefficients 1#, 0.5, 1#
...
Dim y2 As Single
    ...
    new_solid.SetAmbientCoefficients 1#, 1#, 0.5
...
Dim R As Single
    ...
    new_solid.SetAmbientCoefficients 0.5, 1#, 1#
...
Dim new_solid As Solid3d
    ...
    new_solid.SetAmbientCoefficients 0.5, 0.5, 1#
...
Dim s2 As Single
    ...
    new_solid.SetAmbientCoefficients 0.5, 1#, 0.5
    Set Cube = new_solid
End Function
' Make a tetrahedron.
...
Dim D As Single
    ...
    new_solid.SetAmbientCoefficients 1#, 0.5, 0.5
